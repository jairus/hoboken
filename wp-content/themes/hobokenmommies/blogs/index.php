...
<?php get_header( 'buddypress' ); ?>
	...
	<div id="content" <?php if ( is_active_sidebar('blogs') ) : ?>class="two_column"<?php endif; ?>>	
		...
		<form action="" method="post" id="blogs-directory-form" class="dir-form">
			...
			<h1><?php the_title(); ?><?php if ( is_user_logged_in() && bp_blog_signup_enabled() ) : ?> &nbsp;<a class="button" href="<?php echo bp_get_root_domain() . '/' . bp_get_blogs_root_slug() . '/create/' ?>"><?php _e( 'Create a Site', 'buddypress' ); ?></a><?php endif; ?></h1>
