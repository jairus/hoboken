...
<div id="box"><?php locate_template( array( 'groups/single/forum/edit.php' ), true ) ?></div>

<?php elseif ( bp_is_group_forum_topic() ) : ?>
<div id="box"><?php locate_template( array( 'groups/single/forum/topic.php' ), true ) ?></div>
...
<p>You will auto join this group when you start a new topic.</p>
</div>
<?php endif; ?>
