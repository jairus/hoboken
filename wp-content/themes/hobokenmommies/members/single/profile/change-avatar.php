<h2><?php _e( 'Change Your Profile Photo', 'buddypress' ) ?></h2>
...
<p>If you're using your iPad or an iPhone, you will not be able to upload an image from either one of these devices. This feature is only available within iPad/iPhone applications (there's growing pressure on Apple to change that in the near future). You will need to use your desktop or laptop computer to upload an image of yourself instead. Your profile image will be used on your profile and throughout the site. Click below to select a JPG, GIF or PNG format photo from your computer and then click 'Upload Image' to proceed.</p>
</div>
