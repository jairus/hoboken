			...
			<div class="tablenav top">
				<div class="alignleft actions">
					<select name="unconfirmed_action">
						<option value="resend"><?php _e( 'Send Activation Email', 'unconfirmed' ) ?>&nbsp;&nbsp;</option>
				...
				<tr>
					...
					<td class="login">
						...
						<div class="row-actions">
							<span class="edit"><a class="confirm" href="<?php echo wp_nonce_url( add_query_arg( array( 'unconfirmed_action' => 'resend', 'unconfirmed_key' => $user->activation_key ), $this->base_url ), 'unconfirmed_resend_email' ) ?>"><?php _e( 'Send Activation Email', 'unconfirmed' ) ?></a></span>
