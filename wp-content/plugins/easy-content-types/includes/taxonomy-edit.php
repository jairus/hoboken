			...
			foreach( $wpdb->get_results("SELECT * FROM " . $ecpt_db_tax_name . " WHERE id ='" . $_GET['edit-tax'] . "';") as $key => $tax)
			{
				?>			
					...
					<tr class="form-field">
						...
						<td>
							<input type="text" name="tax-singular" id="tax-singular" value="<?php echo utf8_decode($tax->singular_name); ?>" />
					...
					<tr class="form-field">
						...
						<td>
							<input type="text" name="tax-plural" id="tax-plural" value="<?php echo utf8_decode($tax->plural_name); ?>" />
