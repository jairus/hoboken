				...
				{			
					?>			
						...
						<tr class="form-field">
							...
							<td>
								<input type="text" name="posttype-singlular" id="posttype-singlular" value="<?php echo utf8_decode($posttype->singular_name); ?>" />
						...
						<tr class="form-field">
							...
							<td>							
								<input type="text" name="posttype-plural" id="posttype-plural" value="<?php echo utf8_decode($posttype->plural_name); ?>" />
						...
						<tr class="form-field">
							...
							<td>
								<input type="text" name="posttype-slug" id="posttype-slug" value="<?php echo utf8_decode($posttype->slug); ?>" />
						...
						<tr class="form-field">
							...
							<td>
								...
								<p class="description"><?php _e('The position of the post type in the menu. For help: ', 'ecpt'); ?><a href="<?php echo admin_url('/admin.php?page=easy-content-types/easy-content-types.php?help#post-type-advanced'); ?>"><?php _e('documentation', 'ecpt'); ?></p>
							</td>
						</tr>
						<tr class="form-field">
							<th scope="row" valign="top">
						...
						<tr class="form-field">
							...
							<td>
								<input type="text" name="posttype-advanced-supports" id="posttype-advanced-supports" class="regular-text" value="<?php echo !empty($posttype->advanced_supports) ? $posttype->advanced_supports : ''; ?>"/>
