			...
			{			
				?>			
					<tr <?php if(ecpt_is_odd($i)) { echo 'class="alternate"'; } ?> id="ecpt-posttype-<?php echo $type->id; ?>">
						...
						<td><?php echo 'Single: ' . utf8_decode($type->singular_name) . '<br/>Plural: ' . utf8_decode($type->plural_name); ?></td>
						<td><?php echo utf8_decode($type->slug); ?></td>
						<td>
						...
						<td>
							...
							<a href="edit.php?post_type=<?php echo utf8_decode($type->name); ?>" title="Edit" class="ecpt-edit" id="ecpt-edit-<?php echo $type->id; ?>"><?php _e('View', 'ecpt'); ?> <?php echo utf8_decode($type->plural_name); ?></a> |
							<a href="post-new.php?post_type=<?php echo $type->name; ?>" title="Edit" class="ecpt-edit" id="ecpt-edit-<?php echo $type->id; ?>"><?php _e('Add New', 'ecpt'); ?> <?php echo utf8_decode($type->singular_name); ?></a> |
