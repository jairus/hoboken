	...
	<div class="wrap">
		<div id="ecpt-wrap" class="ecpt-settings">
			...
			<form method="post" action="options.php">
				...
				<?php } ?>
				<p><strong><?php _e('Note', 'ecpt'); ?></strong>: <?php _e('If you want more control over how meta field values are displayed, use this function:', 'ecpt'); ?> <a href="<?php echo admin_url('admin.php?page=easy-content-types/easy-content-types.php?help#field-info'); ?>">ecpt_display_meta()</a></p>
